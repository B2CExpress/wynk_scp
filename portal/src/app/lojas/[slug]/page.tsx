...
export default async function StoreDetailPage({ params }: StoreDetailPageProps) {
  ...
  // try/catch envolve só o fetch — JSX fora do bloco pra evitar
  // antipattern do React Server Components (rendering errors não são
  // capturados por try/catch; precisam de error boundary).
  let store;
  try {
    store = await fetchStoreDetail(host, slug);
  } catch (error) {
